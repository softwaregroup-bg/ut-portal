...
declare namespace Portal {
    ...
    export interface handlers<location = ''> {
        ...
        'portal.component.get'?: ut.handler<string, unknown, location>,
        'portal.component.edit'?: ut.handler<{component: {componentId: string}}, unknown, location>,
        'portal.component.delete'?: ut.handler<{componentId: string[]}, unknown, location>,    'portal.dropdown.list'?: ut.handler<dropdownParams, dropdownResult, location>,
